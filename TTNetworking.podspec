...
Pod::Spec.new do |s|
  s.name             = 'TTNetworking'
  s.version          = '1.0.0'
  s.summary          = '基于AFNetworking3.0封装的网络请求框架'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/claudeli@yeah.net/TTNetworking'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'claudeli@yeah.net' => 'claudeli@yeah.net' }
  s.source           = { :git => 'https://github.com/ClaudeLi/CLNetworking.git', :tag => s.version.to_s }
